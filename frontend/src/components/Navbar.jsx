    ...
    <nav ref={navRef} className={cn(
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <button 
          ...
          className="hidden sm:flex items-center gap-2 bg-[var(--bg-main)] border border-[var(--border)] px-4 py-2 rounded-xl text-[var(--text-muted)] w-full max-w-md hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group cursor-text"
        >

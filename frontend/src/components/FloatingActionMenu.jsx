  ...
  return (
    <div ref={menuRef} className="fixed bottom-8 right-8 z-50 flex flex-col items-center">
      ...
      <button
        ...
        className="w-14 h-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110 focus:outline-none"
      >
        <div className={cn("transition-transform duration-300 text-white", isOpen ? "rotate-[135deg]" : "rotate-0")}>
